...
export default function CardButton({ id, buildingName }: IApartment) {
        ...
        <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            ...
            <div className="p-5">
                <Link href={`${PG.BOARD}/detail/${id}`}>
                    <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">{buildingName}</h5>
                </Link>
