...
import apartmentReducer from "@/app/components/apartment/service/apartment-slice";
...
const persistedApartmentReducer = persistReducer(apartmentPersistConfig, apartmentReducer);
